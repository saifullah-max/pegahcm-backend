...
import { deleteResignation, getMyResignation, getResignationById, getResignations, processResignation, updateClearanceStatus, updateResignation } from '../controllers/resignationController';
...
router.get('/user/my', checkPermission("Resignation", "view"), getMyResignation as any)
