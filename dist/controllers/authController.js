...
const emailService_1 = __importDefault(require("../utils/emailService")); // You'll create this email helper
const Prisma_1 = __importDefault(require("../utils/Prisma"));
const register = async (req, res) => {
    try {
        const { username = '', password, email, fullName, roleName = 'user', // <- Use roleName instead of role
        subRoleId } = req.body;
...
const forgotPassword = async (req, res) => {
    ...
    try {
        ...
        await emailService_1.default.sendPasswordResetEmail(email, resetToken);
        return res.status(200).json({ message: 'If that email exists, a reset link has been sent.' });
    }
    catch (error) {
